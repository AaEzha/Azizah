...
$mail->Body    = '<p>Hai '.$_SESSION['namanya'].', your internship program request has been rejected. We are so sorry.<p>
                    <p>For further information and Rejection Letter, you should log in to GMF AeroAsia\'s Web with your own account.</p>
					<p>Enjoy your account.</p>';
$mail->AltBody = 'Hai '.$_SESSION['namanya'].', your internship program request has been rejected. We are so sorry. For further information and Rejection Letter, you should log in to GMF AeroAsia\'s Web with your own account. Enjoy your account.';
